...
go run main.go -kubeconfig=/Users/hong.zhang/.kube/config -logtostderr=true -lease-lock-name=example -lease-lock-namespace=default -id=0 -port=8084
...
run and test:
./sample-controller  -kubeconfig=/Users/hong.zhang/.kube/config -logtostderr=true -lease-lock-name=example -lease-lock-namespace=default -id=1 -port=8085

./sample-controller  -kubeconfig=/Users/hong.zhang/.kube/config -logtostderr=true -lease-lock-name=example -lease-lock-namespace=default -id=2 -port=8086

./sample-controller  -kubeconfig=/Users/hong.zhang/.kube/config -logtostderr=true -lease-lock-name=example -lease-lock-namespace=default -id=3 -port=8087